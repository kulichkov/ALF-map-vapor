...
final class Artwork: SQLiteModel {
	...
	init(id: Int? = nil, language: String?, title: String? = nil, location: Location? = nil, viewPoint: Location? = nil, icon: String? = nil, iconDark: String? = nil, excerpt: String? = nil, thumbnailImage: String? = nil, content: String? = nil, image: String? = nil, artist: Artist? = nil) {
		self.id = id
